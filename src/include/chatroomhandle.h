...
#ifdef _QT_MAKE_
        : QEvent(QEvent::User), m_nParam(nParam)
#else
        : m_nParam(nParam)
#endif
...
#ifdef _QT_MAKE_
			this->m_nEventParameter = pParameter->GetEventParameter();
            this->t = pParameter->type();
            this->m_receiver = pParameter->receiver();
            this->m_receiveKey = pParameter->receiveKey();
#endif
		}
		return *this;
	}
...
public:
	...
	bool m_bPrivate;
#ifdef _QT_MAKE_
    int m_nAckType; // for OnMsgReceipt
#endif
};
...
public:
	...
	int m_nP2PData;
#ifdef _QT_MAKE_
    int m_nFlag;    // for CR_WM_P2P_RESPONSE
#endif
};
...
typedef enum CR_WINDOW_MESSAGE
{
...
#ifdef _QT_MAKE_
    CR_WM_ENTER_ROOM			= QEvent::User+0x1101
#else
	...
	*/
#ifdef _QT_MAKE_
    , CR_WM_SEND_RICH			= QEvent::User+0x1111
#else
	...
	*/
#ifdef _QT_MAKE_
    , CR_WM_SAVE2CLOUD_DRIVE			= QEvent::User+0x1121
#else
	...
	// const CCrInfo* pParameter = (const CCrInfo*)wp;
#ifdef _QT_MAKE_
    , CR_WM_INVALIDATE_SESSION			= QEvent::User+0x1131
#else
...
#ifdef _QT_MAKE_
    , CR_WM_P2P_REQUEST						= QEvent::User+0x1141
#else
	...
	, CR_WM_P2P_OK
#ifdef _QT_MAKE_
    , CR_WM_EVENT_RESULT					= QEvent::User+0x1191
#endif
}CR_WINDOW_MESSAGE;
