...
#include "ui_dialoggroupinfo.h"
#include "ebmessagebox.h"

DialogGroupInfo::DialogGroupInfo(QWidget *parent) :
    EbDialogBase(parent),
    ui(new Ui::DialogGroupInfo)
...
void DialogGroupInfo::updateLocaleInfo()
{
    /// 显示右上角关闭按钮
...
void DialogGroupInfo::onClickedLabelManagerUserName()
{
