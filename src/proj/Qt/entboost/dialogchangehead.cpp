...
DialogChangeHead::DialogChangeHead(QWidget *parent) :
    EbDialogBase(parent),
    ui(new Ui::DialogChangeHead)
...
DialogChangeHead::~DialogChangeHead()
{
...
void DialogChangeHead::updateLocaleInfo()
{
...
void DialogChangeHead::setHeadResorceFile(const QString &headResourceFile)
{
...
void DialogChangeHead::onClickedPushButtonDefault()
{
    updateClickedPushButton(sender());
}

void DialogChangeHead::onClickedPushButtonCustom()
{
    updateClickedPushButton(sender());
}

void DialogChangeHead::updateClickedPushButton(const QObject *sender)
{
...
void DialogChangeHead::onClickedPushButtonOpenFile()
{
...
void DialogChangeHead::onClickedListWidgetDefaultHeads(const QModelIndex &index)
{
...
void DialogChangeHead::resizeEvent(QResizeEvent * e)
{
...
void DialogChangeHead::loadDefaultHeadImage()
{
//    /// for test
//    for (int i=0; i<10; i++) {
...
//void DialogChangeHead::timerEvent(QTimerEvent * e)
//{
