...
#include "ui_dialogmemberinfo.h"
#include "ebmessagebox.h"
#include "dialogchangehead.h"

const QSize const_user_head_size(80,80);
DialogMemberInfo::DialogMemberInfo(QWidget *parent) :
    EbDialogBase(parent),
    ui(new Ui::DialogMemberInfo)
  , m_labelUserHead(0)
...
DialogMemberInfo::~DialogMemberInfo()
{
...
void DialogMemberInfo::updateLocaleInfo()
{
    /// 显示右上角关闭按钮
...
//void DialogMemberInfo::open()
//{

//    EbDialogBase::open();
//}

int DialogMemberInfo::exec()
{
    updateUserHeadImage();
...
void DialogMemberInfo::onSelectedHeadImage(qint64 resourceId, const QString &resourceFile)
{
...
void DialogMemberInfo::updateUserHeadImage()
{
...
void DialogMemberInfo::onClickedLabelUserHead()
{

    if (m_dialogChangeHead==0) {
        m_dialogChangeHead = new DialogChangeHead;
