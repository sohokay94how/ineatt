...
#include "ui_dialogemotionselect.h"
...
DialogEmotionSelect::DialogEmotionSelect(QWidget *parent) :
    EbDialogBase(parent),
    ui(new Ui::DialogEmotionSelect)
...
DialogEmotionSelect::~DialogEmotionSelect()
{
...
void DialogEmotionSelect::updateLocaleInfo()
{
...
void DialogEmotionSelect::onItemClicked(QListWidgetItem *item)
{
...
void DialogEmotionSelect::onItemEntered(QListWidgetItem *item)
{
//    const int index = item->data(Qt::UserRole).toInt();

}

void DialogEmotionSelect::resizeEvent(QResizeEvent * e)
{
    const int titleHeight = theLocales.titleBackgroundHeight();
...
void DialogEmotionSelect::checkFocusOut()
{
...
void DialogEmotionSelect::focusOutEvent(QFocusEvent *event)
{
    checkFocusOut();
...
bool DialogEmotionSelect::eventFilter(QObject *obj, QEvent *e)
{
...
void DialogEmotionSelect::loadEmotion()
{
...
void DialogEmotionSelect::timerEvent(QTimerEvent *event)
{
