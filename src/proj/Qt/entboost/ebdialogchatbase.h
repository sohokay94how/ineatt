...
public:
    explicit EbDialogChatBase(const EbcCallInfo::pointer& pCallInfo,QWidget *parent = 0);
    virtual ~EbDialogChatBase();
    typedef boost::shared_ptr<EbDialogChatBase> pointer;
    static EbDialogChatBase::pointer create(const EbcCallInfo::pointer& pCallInfo,QWidget *parent = 0) {
