...
#include "dialogconnectsetting.h"
...
//        ui->pushButton->setPalette(pPaletteBg);
        ...
        IconHelper::Instance()->SetIcon(m_labelAccountIcon,QChar(0xf2c0),11);
...
//        m_labelAccountIcon->installEventFilter(this);
        ...
        IconHelper::Instance()->SetIcon(ui->pushButtonDeleteAccount,QChar(0xf00d),10 );
        /// for test data
//        for (int i=0; i<10; i++) {
//            QListWidgetItem * pItem0 = new QListWidgetItem("user1", ui->listWidgetLoginRecords);
//            ui->listWidgetLoginRecords->insertItem( i, pItem0 );
//        }
        IconHelper::Instance()->SetIcon(ui->labelPasswordIcon,QChar(0xf084),11);
...
//void DialogLogin::refreshSkin(void)
//{
//    this->showTitleBackground(theApp->getMainColor(), 190);
//}

void DialogLogin::updateEntLogo(const QString& fileName)
{
...
void DialogLogin::updateProductName(void)
{
...
void DialogLogin::setErrorText(const QString& errorText, bool bMessageShowError)
{
...
void DialogLogin::processDatas(void)
{
    // 加载本机登录帐号
    loadLoginData();
    // 创建“setting”菜单数据
...
void DialogLogin::setLoginInfo(QListWidgetItem* item, bool bAccountSelect)
{
...
void DialogLogin::setLoginInfo(const CLoginInfo::pointer& loginInfo, bool bAccountSelect)
{
...
void DialogLogin::loadLoginData(void)
{
    ui->lineEditAccount->setFocus();
    char lpszBuffer[260];
    int nCookie = 0;
...
void DialogLogin::createMenuData(void)
{
...
bool DialogLogin::event(QEvent *e)
#else
void DialogLogin::customEvent(QEvent *e)
#endif
{
...
bool DialogLogin::eventFilter(QObject *obj, QEvent *e)
{
...
//void DialogLogin::onUpdateEntLogo(QEvent* )
//{
...
void DialogLogin::onAppIdSuccess(QEvent *)
{
...
void DialogLogin::onAppIdError(QEvent * e)
{
    updateEntLogo("");
    const EB_Event * pEvent = (EB_Event*)e;
...
void DialogLogin::onLogonSuccess(QEvent *e)
{
...
//void DialogLogin::onLogonTimeout(QEvent *e)
//{
//    onLogonError(e);
//}

void DialogLogin::onLogonError(QEvent *e)
{
    const EB_AccountInfo * pAccountInfo = (EB_AccountInfo*)e;
...
void DialogLogin::onOnlineAnother(QEvent *e)
{

}

//#include "dialogframelist.h"
void DialogLogin::onClickPushButtonSetting(void)
{
    /// for test
//    DialogFrameList dlg;
//    dlg.exec();
...
void DialogLogin::onClickedEntLogo()
{
...
void DialogLogin::onClickSelectColor(void)
{
...
void DialogLogin::setLogonCtrlEnabled(bool enable)
{
...
void DialogLogin::onClickPushButtonLogon(void)
{
...
void DialogLogin::onTextChangedEditAccount(const QString& sEditAccountText)
{
...
void DialogLogin::onClickedLabelAccountIcon(void)
{
    if ( ui->listWidgetLoginRecords->isVisible() ) {
        ui->listWidgetLoginRecords->setVisible(false);
        ui->pushButtonDeleteAccount->setVisible(false);
...
void DialogLogin::onItemClickedLoginRecords(QListWidgetItem* item)
{
    setLoginInfo( item,true );
    ui->listWidgetLoginRecords->setVisible(false);
    ui->pushButtonDeleteAccount->setVisible(false);
}
void DialogLogin::onItemSelectionChangedLoginRecords(void)
{
...
void DialogLogin::onItemEnteredLoginRecords(QListWidgetItem* item)
{
    /// 滚动条能正常显示
...
//void DialogLogin::onCurrentItemChangedLoginRecords(QListWidgetItem *current, QListWidgetItem *previous)
//{
//    if (current==NULL) {
//        return;
//    }
...
//void DialogLogin::onCurrentRowChangedLoginRecords(int currentRow)
//{
...
void DialogLogin::onClickPushButtonDeleteAccount(void)
{
...
void DialogLogin::onClickPushButtonVisitor(void)
{
...
void DialogLogin::onClickPushButtonRegister(void)
{
    // for test
...
//    return;
    ...
    DialogRegister pDialogRegister;
...
void DialogLogin::onClickPushButtonForgetPwd(void)
{
